...
namespace DataAccess.DAO
{
	...
	public class SqlDAO
	{
		...
		private SqlDAO()
		{
			connectionString = "Data Source=sv-cc-apg.database.windows.net;Initial Catalog=2023C2-CenfoChat_APG;Persist Security Info=True;User ID=sysman;Password=Cenfotec123";
		}
